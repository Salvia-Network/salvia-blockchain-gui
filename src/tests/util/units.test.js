...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of salvia', () => {
      const result = units.getUnit('salvia');

      expect(result).toBe(1);
    });
    it('gets unit of seed', () => {
      const result = units.getUnit('seed');
    ...
    it('gets unit of salvia using alias', () => {
      const result = units.getUnit('ch');

      expect(result).toBe(1);
    });
    it('gets unit of seed using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of salvia', () => {
      const result = units.getDisplay('salvia');
    ...
    it('gets display of seed', () => {
      const result = units.getDisplay('seed');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('salvia', 9);

      const result = units.getUnit('salvia');

      expect(result).toEqual(9);

      units.setUnit('salvia', 1);
    });
  });
  describe('#setDisplay', () => {
