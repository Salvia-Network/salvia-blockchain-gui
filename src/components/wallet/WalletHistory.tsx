...
import { Card, CopyToClipboard, Flex, Table } from '@salvia/core';
import type { Row } from '../core/components/Table/Table';
import {
  seed_to_salvia_string,
  ...
  },
  {
    field: (row: Row) =>
      type === WalletType.COLOURED_COIN
        ? seed_to_colouredcoin_string(row.amount)
        : seed_to_salvia_string(row.amount),
    title: <Trans>Amount</Trans>,
  },
  {
    field: (row: Row) => seed_to_salvia_string(row.fee_amount),
