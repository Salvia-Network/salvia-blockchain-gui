...
import { /* seed_to_salvia_string, */ salvia_to_seed } from '../../../util/salvia';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {seed_to_salvia_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of salvia in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Salvia that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Salvia that you have just spent but is not
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      openDialog(
        <AlertDialog>
          <Trans>
            Error: Cannot send salvia to coloured address. Please enter a salvia
            address.
          </Trans>
        </AlertDialog>,
      );
    ...
    if (address.slice(0, 12) === 'salvia_addr://') {
    ...
    const amountValue = Number.parseFloat(salvia_to_seed(amount));
    const feeValue = Number.parseFloat(salvia_to_seed(fee));
