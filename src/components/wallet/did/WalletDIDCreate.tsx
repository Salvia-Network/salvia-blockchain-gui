...
import { Amount, Form, AlertDialog, Back, Card, Flex, ButtonLoading } from '@salvia/core';
import {
  Typography,
  Button,
  Box,
...
export default function WalletDIDCreate() {
  ...
  async function onSubmit(data) {
    try {
      ...
      const amount_val = salvia_to_seed(data.amount);
      if (
        amount_val === '' ||
        Number(amount_val) === 0 ||
        !Number(amount_val) ||
          ...
          <Flex flexDirection="column" gap={3}>
            <Flex flexDirection="column" gap={1}>
              <Flex alignItems="center" gap={1}>
                ...
                <Tooltip title="The amount of Salvia you enter must correspond to an even amount of seeds. One additional seed will be added to the total amount for security purposes.">
                  ...
                  >
                    {() => (
                      <Flex display="flex" gap={1} alignItems="center">
                        ...
                        <Tooltip title="This additional seed will be added to the total amount for security purposes.">
                          <HelpIcon style={{ color: '#c8c8c8', fontSize: 12 }} />
                        </Tooltip>
                      </Flex>
                    )}
