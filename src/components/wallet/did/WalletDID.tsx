...
import { AlertDialog, Card, Flex, Loading, Dropzone } from '@salvia/core';
import {
...
import { seed_to_salvia_string } from '../../../util/salvia';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {seed_to_salvia_string(props.balance)} TXSLV
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const CreateAttest = (props) => {
  ...
  function createAttestPacket() {
    ...
    if (address.substring(0, 12) === 'salvia_addr://') {
...
const CashoutCard = (props) => {
  ...
  function cashout() {
    ...
    if (puzzlehash.slice(0, 12) === 'salvia_addr://') {
