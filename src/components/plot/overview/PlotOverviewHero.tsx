...
import { CardHero, Flex, Link } from '@salvia/core';
import { PlotHero as PlotHeroIcon } from '@salvia/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Salvia. '
              }
              <Link
                target="_blank"
                href="https://github.com/Salvia-Network/salvia-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
