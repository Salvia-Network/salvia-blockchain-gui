...
import { CardStep, Select } from '@salvia/core';
import {
  FormControl,
  FormHelperText,
  Grid,
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Salvia Proof of Space plotter. If unsure,
            use the default Salvia Proof of Space plotter.
        </Trans>
      </Typography>
