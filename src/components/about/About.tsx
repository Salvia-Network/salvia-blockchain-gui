...
import icon from '../../assets/img/salvia_circle.svg';
...
const url = 'https://salvianetwork.net';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Salvia Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Salvia-Network/salvia-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
